      ...
      <CardHeader className="flex-1">
        <CardTitle className="min-h-[2lh] min-w-0">
          <a
            ...
            className="line-clamp-2 outline-none hover:underline focus-visible:underline"
          >
            {resource.title}
          </a>
        </CardTitle>
        ...
        <div className="flex min-w-0 items-center gap-1 overflow-hidden">
          <Badge
            ...
            render={
              <button
                type="button"
                onClick={() => onFilter(resource.categorySlug, null)}
              />
            }
          >
            {resource.category}
            ...
            <Badge
              ...
              render={
                <button
                  type="button"
                  onClick={() =>
                    onFilter(resource.categorySlug, resource.subcategorySlug)
                  }
                />
              }
            >
