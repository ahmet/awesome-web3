...
-  [MRC GlobalPay](https://mrcglobalpay.com) - Regulated Canadian MSB (C100000015) for non-custodial settlement rails with a machine-readable [manifest](https://mrcglobalpay.com/trading-bot-manifest.json).
