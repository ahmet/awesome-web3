...
- [NanoStack](https://api.nano-labs.io) - Permissionless cross-chain execution API supporting 86 chains including BTC, ETH, Base, Arbitrum, Optimism, Solana, Cosmos, and Polkadot. 8-15 bps fees. No API key required. ([OpenAPI](https://api.nano-labs.io/.well-known/openapi.json))
