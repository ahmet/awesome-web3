...
- [CoinPing](https://t.me/CoinPingAlertBot) — Multi-condition crypto price alert bot (threshold, 24h change %, cross-exchange spread). Free tier with 3 alert slots. [Open source](https://github.com/SeigeC/coinping-bot) (Go)
